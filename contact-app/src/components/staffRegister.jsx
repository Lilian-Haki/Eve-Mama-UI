  ...
  return (
    <div className="inline-flex rounded ml-[200px] mt-[100px]">
      ...
      <div className="mt-8 text-center">
        ...
        <Box sx={{ display: 'flex', alignItems: 'flex-end', marginTop:'14px' , marginBottom:"10px"}}>
        <WorkOutlinedIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
        ...
        <div>
        <Link to="/staff_login" className="text-zinc-600 ml-9 hover:text-purple-700" >Already have an account? Login</Link>
          </div>
      </div>
    </div>
  );
