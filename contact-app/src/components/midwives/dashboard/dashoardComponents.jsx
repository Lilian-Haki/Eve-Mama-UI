     ...
     <div className="bg-gray-200 lg:w-[1500px] sm:w-[100px] min-h-screen">
       ...
       >
         ...
         <button
             ...
             >
               <img src={logo} alt="home" className="active:bg-white text-black flex w-6 h-6" />
         ...
         <button
             ...
             >
               <img src={logo} alt="listings" className="active:bg-white flex w-6 h-6" />
               <p className="font-roboto text-lg">Calendar</p>
             </button>
         </Link>
         ...
         <button
             ...
             >
               <img src={logo} alt="users" className="flex w-6 h-6" />
         ...
         >
           <img src={logo} alt="Reports" className="flex w-6 h-6" />
           <p className="font-roboto text-lg">Patients</p>
         </button>
         <button
           className={`w-[200px] h-14 py-2 px-4 items-center gap-3 flex mt-6 ml-6 rounded-lg hover:bg-aliceblue ${
             selected === "reports" ? "active" : ""
         ...
         >
           <img src={logo} alt="Reports" className="flex w-6 h-6" />
           <p className="font-roboto text-lg">Notifications</p>
         </button>
         <button
           className={`w-[200px] h-14 py-2 px-4 items-center gap-3 flex mt-6 ml-6 rounded-lg hover:bg-aliceblue ${
             selected === "reports" ? "active" : ""
         ...
         >
           <img src={logo} alt="Reports" className="flex w-6 h-6" />
           <p className="font-roboto text-lg">Settings</p>
         </button>
