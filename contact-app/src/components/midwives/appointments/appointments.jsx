...
import Dashboard from '../dashboard/dashoardComponents';
import MidPendingAppointments from '../appointments/pendingAppointment';
import MidApprovedAppointments from '../appointments/approvedAppointments';
import MidCompletedAppointments from '../appointments/completedAppointment';
  ...
  return (
    <div>
      ...
      <div className="lg:ml-[13px] mt-[145px] w-[1120px] bg-gray-200 pb-0 ">
        ...
        ) : openAddListings === "PENDING" ? (
          <MidPendingAppointments setData={setData} setOpenAddListings={setOpenAddListings} />
        ) : openAddListings === "APPROVED" ? (
          <MidApprovedAppointments setData={setData} setOpenAddListings={setOpenAddListings} />
        ) : openAddListings === "COMPLETED" ? (
          <MidCompletedAppointments setOpenAddListings={setOpenAddListings} />
...
export default MIDAPPOINTMENTS;
